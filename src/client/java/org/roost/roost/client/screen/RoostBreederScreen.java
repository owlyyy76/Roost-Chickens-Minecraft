...
public class RoostBreederScreen extends HandledScreen<RoostBreederScreenHandler> {

    private static final Identifier TEXTURE =
            Identifier.of("roost", "textures/gui/roost_breeder_gui.png");
    ...
    public RoostBreederScreen(RoostBreederScreenHandler handler, PlayerInventory inventory, Text title) {
